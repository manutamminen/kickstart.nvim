...
vim.api.nvim_create_autocmd({"FileType", "BufEnter"},
  { pattern = {"*.R", "*.r"},
    callback = function()
      vim.keymap.set('n', 'tt', ':call StartR("R")<CR><C-w>H')
      vim.keymap.set('n', '<C-c><C-c>', ':call SendParagraphToR("echo", "down")<CR>')
      vim.keymap.set('i', '<C-c><C-c>', '<Esc>:call SendParagraphToR("echo", "down")<CR>')
      vim.keymap.set({'n', 'i'}, 'åå', '<Esc>:normal! $a %>%<CR>')
      vim.keymap.set({'n', 'i'}, 'ÅÅ', '<Esc>:s/ %>%//<CR>')
      vim.keymap.set({'n', 'i'}, '--', '<Esc>:normal! a <-<CR>a')
  end
  })
